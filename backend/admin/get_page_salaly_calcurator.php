			...
			if (json_res.status == true) {
				...
				$.each(json_res.data, function(index, val) {
					...
					// console.log(val.maidname);
						...
						contentTable+= "<td><form action='calcurator_salary.php' method='post' target='_blank'><input type='hidden' name='maid_id' value='"+val.maid_id+"' /><input type='hidden' name='startDate' value='"+json_res.startDate+"' /><input type='hidden' name='endDate' value='"+json_res.endDate+"' /><button type='submit' class='btn btn-info'>Click</button></form></td>";
