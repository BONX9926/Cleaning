				...
				<div class="row state-overview">
					...
					<div class="col-lg-3 col-sm-6">
						<section class="panel">
							...
							<div class="value">
								<h1><b id="like" style="color:#484848">0</b></h1>
